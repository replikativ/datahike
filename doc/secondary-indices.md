...
Stratum requires no *separate* storage — its columnar dataset lives in memory and persists into Datahike's own konserve store on commit, where the GC mark walks it (see above).
