(ns datahike.middleware.utils-test
...
(deftest apply-middlewares-should-throw-exception-on-non-resolved-symbols
  (let [combined (utils/apply-middlewares ['is-not-there
                                           'datahike.middleware.utils-test/test-handler-inc-second]
                                          (fn [a b] (+ a b)))]
    (is (thrown-with-msg? clojure.lang.ExceptionInfo #"Invalid middleware.😱" (combined 1 1)))))
