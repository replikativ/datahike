...
(defn create-database
  ...
  ([] (dc/create-database))
  ([config & deprecated-opts] (apply dc/create-database config deprecated-opts)))
...
(defn is-filtered
  ...
  [x]
  (instance? datahike.db.FilteredDB x))
...
(defn listen
  ...
  ([conn callback]
   (dcore/listen! conn callback))
  ([conn key callback]
   (dcore/listen! conn key callback)))

(defn unlisten
  "Removes registered listener from connection. See also [[listen]]."
  [conn key]
  (dcore/unlisten! conn key))
