...
if ('--all' === process.argv[2])
  var res = merge(datahike.test.test_cljs(), tests_js.test_all())
else if ('--js' === process.argv[2]) var res = tests_js.test_all()
else if ('--cljs' === process.argv[2]) var res = datahike.test.test_cljs()
else {
